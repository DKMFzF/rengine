...
glm::vec3& ModelObject::rotation() noexcept { return getComponent<Transform>().rotation; }
...
const glm::vec3& ModelObject::rotation() const noexcept { return getComponent<Transform>().rotation; }
